...
export function TmdbItem({ id, title, image, type, rating, year }: TMDBItem) {
  return (
    <Card className="w-48 overflow-hidden group cursor-pointer hover:shadow-xl transition-all duration-300 hover:scale-105 p-0">
